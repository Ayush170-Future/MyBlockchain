...
public class Blockchain {
	...
	public static void main(String[] args) {
		...
		String[] genesisTransactions = {"Elon made Ayush a Billionaire by giving him 1000 bitcoin", "Ayush gave away all the bitcoins to poor people because he is a noble guy"};
		Block genesisBlock = new Block(0, genesisTransactions);      //Creating Genesis block with some random transactions
		
		String[] block2Transactions = {"Bill gave away 10000 bitcoins to the people in Africa", "Gates foundation recieved 10000 bitcoins of donation from some unknown source, Africa suspected"};
